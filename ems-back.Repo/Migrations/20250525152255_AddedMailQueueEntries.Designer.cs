...
namespace ems_back.Repo.Migrations
{
    ...
    [Migration("20250525152255_AddedMailQueueEntries")]
    partial class AddedMailQueueEntries
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ems_back.Repo.Models.Mail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("sendToAllParticipants")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("ems_back.Repo.Models.MailQueueEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("MailQueueEntries");
                });

            modelBuilder.Entity("ems_back.Repo.Models.MailRun", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ems_back.Repo.Models.OrganizationUser", b =>
                {
                    ...
                    b.HasIndex("UserId", "OrganizationId", "UserRole")
                        .IsUnique();
            ...
            modelBuilder.Entity("ems_back.Repo.Models.MailRun", b =>
                {
                    b.HasOne("ems_back.Repo.Models.Mail", "Mail")
                        .WithMany("MailRuns")
