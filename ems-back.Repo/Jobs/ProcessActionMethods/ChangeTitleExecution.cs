...
{
    public class ChangeTitleExecution
    {
        private readonly ApplicationDbContext _dbContext;

        // Constructor to initialize _dbContext
        public ChangeTitleExecution(ApplicationDbContext dbContext)
        {
            _dbContext = dbContext;
        }
        public async Task HandleChangeTitleActionAsync(TitleChangeModel action)
        {
            try
            {
